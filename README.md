...
3. **Shared plotting utilities** (`proteomics_analysis.plotting`) — PCA plots,
...
```toml
dependencies = [
    "proteomics_analysis @ git+https://github.com/<you>/proteomics_analysis.git",
]
```

## Modules

- `proteomics_analysis.stats_utils` — `add_fdr_columns`
- `proteomics_analysis.glm` — `fit_GLMs`, `contrasts_delta_method`
- `proteomics_analysis.gsea` — `run_gsea`
- `proteomics_analysis.plotting` — `plot_pca`, `make_volcano_plots`, `plot_rank_change`
